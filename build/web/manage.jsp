...
<html class=" h-100" lang="en" class="bg-dark h-100">
    ...
    <body class="d-flex flex-column h-100">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-11 col-xs-12 series-content">
                        ...
                        <div id="addFormContainer">
                            <div id="addFormContent">
                                <form action="add" id="addForm" style="display: none" method="POST">
                                    <h3><strong>Add a New Series</strong></h3>
                                    <br/>
                                    <table>
                                        <tr>
                                            <td><strong>Manga ID:</strong></td>
                                            <td><input type="text" name="mangaId" required></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea name="synopsis" rows="4" cols="50" required></textarea></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Cover Image URL:</strong></td>
                                            <td><input type="text" name="coverImageUrl" required></td>
                                        </tr>
                                        <tr>
        ...
        <script>
            const addSeriesButton = document.querySelector('.add-btn');
