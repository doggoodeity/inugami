!function(t, e) {
    ...
    , function(t, e, n) {
        function l(t, e) {
            ...
            this.autoCloseAfter = n.autoCloseAfter ? n.autoCloseAfter : 1500,
            this.skipInitial = !n.skipInitial || n.skipInitial,
            this.logging = !!n.logging && n.logging,
            n.hasOwnProperty("modalBackdrop")) {
                if ("boolean" != typeof n.modalBackdrop && "onlySmallScreens" !== n.modalBackdrop)
        ...
        l.prototype = {
            log: function() {
                if (this.logging) {
                    for (var t, e = arguments.length, n = new Array(e), l = 0; l < e; l++)
                        n[l] = arguments[l];
                    (t = console).debug.apply(t, ["[RS-WIDGET] "].concat(n))
                }
            },
            eventHandler: function(t, e) {
                var n = this;
                switch (this.log("EVENT: ", t),
                t) {
                case "ready":
                ...
                case "sync-req-done":
                    ...
                    setTimeout((function() {
                        n.syncInProgress && (n.rsConnectedLabel.textContent = "Synchronizing")
                    }
                    ), 1e3);
                    break;
                case "sync-done":
                    ...
                    this.rsWidget.classList.contains("rs-state-unauthorized") || !this.rs.remote.online ? this.updateLastSyncedOutput() : this.rs.remote.online && (this.lastSynced = new Date,
                    this.rsConnectedLabel.textContent = "Synced just now"),
                    !this.closed && this.shouldCloseWhenSyncDone && setTimeout(this.close.bind(this), this.autoCloseAfter);
                    break;
                case "disconnected":
                    this.active = !1,
                    this.setOnline(),
                ...
                case "connected":
                    this.active = !0,
                    this.online = !0,
                    this.rs.hasFeature("Sync") ? (this.shouldCloseWhenSyncDone = !0,
                    this.rs.on("sync-req-done", (function() {
                        return n.eventHandler("sync-req-done")
                    }
                    )),
                    this.rs.on("sync-done", (function() {
                        return n.eventHandler("sync-done")
                    }
                    ))) : (this.rsSyncButton.classList.add("rs-hidden"),
                    setTimeout(this.close.bind(this), this.autoCloseAfter));
                    var l = this.rs.remote.userAddress;
                    this.rsConnectedUser.innerHTML = l,
                ...
                case "error":
                    this.setBackendClass(this.rs.backend),
                    "DiscoveryError" === e.name ? this.handleDiscoveryError(e) : "SyncError" === e.name ? this.handleSyncError(e) : "Unauthorized" === e.name ? this.handleUnauthorized(e) : console.debug("Encountered unhandled error", e)
                }
            },
            setState: function(t) {
                if (t) {
                    ...
                    e && (e.classList.remove("rs-selected"),
                    e.setAttribute("aria-hidden", "true"));
                    var n = document.querySelector(".rs-box.rs-box-" + t);
                    n && (n.classList.add("rs-selected"),
                    n.setAttribute("aria-hidden", "false"));
                    var l = this.rsWidget.className.match(/rs-state-\S+/g)[0];
                    this.rsWidget.classList.remove(l),
                    this.rsWidget.classList.add("rs-state-".concat(t || this.state)),
                    this.state = t
                }
            },
            setInitialState: function() {
                this.closed || this.close(),
                this.skipInitial ? this.showChooseOrSignIn() : this.setState("initial")
            },
            createHtmlTemplate: function() {
                ...
                return e.innerHTML = n(3).default,
                t.appendChild(e),
                t
            },
            createBackdropHtml: function() {
                var t = document.createElement("div");
                t.classList.add("remotestorage-widget-modal-backdrop"),
                document.body.appendChild(t)
            },
            setModalClass: function() {
                if (this.modalBackdrop) {
                    if ("onlySmallScreens" === this.modalBackdrop && !this.isSmallScreen())
                        return;
            ...
            setupElements: function() {
                ...
                this.rs.apiKeys.hasOwnProperty("googledrive") || this.rsChooseGoogleDriveButton.parentNode.removeChild(this.rsChooseGoogleDriveButton),
                this.rs.apiKeys.hasOwnProperty("dropbox") || this.rsChooseDropboxButton.parentNode.removeChild(this.rsChooseDropboxButton),
            ...
            attach: function(t) {
                ...
                var e, n = this.createHtmlTemplate();
                if (t) {
                    if (e = document.getElementById(t),
                    !parent)
                        throw 'Failed to find target DOM element with id="' + t + '"'
                } else
                    e = document.body;
                e.appendChild(n),
                this.setupElements(),
            ...
            setEventListeners: function() {
                ...
                this.rsSignInForm.addEventListener("submit", (function(e) {
                    ...
                    t.disableConnectButton(),
                    t.rs.connect(n)
                }
                ))
            },
            showChooseOrSignIn: function() {
                this.rsWidget.classList.contains("rs-modal") && (this.rsBackdrop.style.display = "block",
                this.rsBackdrop.classList.add("visible")),
                this.rs.apiKeys && 0 < Object.keys(this.rs.apiKeys).length ? this.setState("choose") : this.setState("sign-in")
            },
            setClickHandlers: function() {
                ...
                this.rs.hasFeature("Sync") && this.rsSyncButton.addEventListener("click", (function() {
                    t.rsSyncButton.classList.contains("rs-rotate") ? (t.rs.stopSync(),
                    t.rsSyncButton.classList.remove("rs-rotate")) : (t.rsConnectedLabel.textContent = "Synchronizing",
                    t.rs.startSync(),
            ...
            toggle: function() {
                this.closed ? this.open() : "initial" === this.state ? this.showChooseOrSignIn() : this.close()
            },
            open: function() {
                this.closed = !1,
                this.rsWidget.classList.remove("rs-closed"),
                this.shouldCloseWhenSyncDone = !1;
            ...
            close: function() {
                ...
                if ("error" !== this.state) {
                    if (this.leaveOpen)
                        this.active ? this.setState("connected") : this.setInitialState();
                    else {
                        this.closed = !0,
                        this.rsWidget.classList.add("rs-closed");
                        var e = document.querySelector(".rs-box.rs-selected");
                        e && e.setAttribute("aria-hidden", "true"),
                        this.active || this.setInitialState()
                    }
                    this.rsWidget.classList.contains("rs-modal") && (this.rsBackdrop.classList.remove("visible"),
                    setTimeout((function() {
            ...
            disableConnectButton: function() {
                this.rsConnectButton.disabled = !0,
                this.rsConnectButton.classList.add("rs-connecting");
                var t = n(4).default;
                this.rsConnectButton.innerHTML = "Connecting ".concat(t)
            },
            enableConnectButton: function() {
                this.rsConnectButton.disabled = !1,
                this.rsConnectButton.textContent = "Connect",
                this.rsConnectButton.classList.remove("rs-connecting")
            },
            setOffline: function() {
                this.online && (this.rsWidget.classList.add("rs-offline"),
                this.rsConnectedLabel.textContent = "Offline",
                this.online = !1)
            },
            setOnline: function() {
                this.online || (this.rsWidget.classList.remove("rs-offline"),
                this.active && (this.rsConnectedLabel.textContent = "Connected")),
                this.online = !0
            },
            setBackendClass: function(t) {
            ...
            showErrorBox: function(t) {
                this.rsErrorBox.innerHTML = t,
                this.setState("error")
            },
            ...
            handleDiscoveryError: function(t) {
            ...
            handleSyncError: function(t) {
                console.debug("Encountered SyncError", t),
                this.setOffline()
            },
            handleUnauthorized: function(t) {
                t.code && "access_denied" === t.code ? this.rs.disconnect() : (this.open(),
            ...
            updateLastSyncedOutput: function() {
                if (this.lastSynced) {
                    var t = new Date
                      , e = Math.round((t.getTime() - this.lastSynced.getTime()) / 1e3);
                    document.querySelector(".rs-box-connected .rs-sub-headline").innerHTML = "Synced ".concat(e, " seconds ago")
                }
            },
